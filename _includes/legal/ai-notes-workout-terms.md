# Terms and Conditions for Workout

Last updated: May 2, 2026

Please read these Terms and Conditions carefully before using Workout.
...
- **Application** means the software program provided by the Company and downloaded by You on a Device, named Workout.
...
Your use of the Service is also subject to Our Privacy Policy, which explains how the Application handles information related to workout notes, training history, Apple Health, iCloud sync, voice input, purchases, analytics, device permissions, and support requests.
...
Workout is a training log for capturing informal workout notes and turning them into structured workout history. The Service may include note parsing, voice input, workout history, exercise detail pages, personal record tracking, charts, insights, reminders, data import and export, Apple Health sync, iCloud sync, and paid Pro features.

The Service is intended for general fitness logging, habit tracking, and informational support. It is not medical advice, coaching, physical therapy, diagnosis, treatment, or a substitute for professional care. If You have pain, injury, a medical condition, or questions about exercise, consult a qualified healthcare professional or trainer. Stop using the Service if using it distracts You from safe training or causes discomfort.

Parsed workout data, insights, charts, personal records, and estimates may be incomplete, inaccurate, delayed, or based on notes You entered incorrectly. You are responsible for reviewing important information before relying on it.

## Device Permissions, Apple Health, and Voice Input

Some features require permissions from Your Device, such as microphone access, speech recognition, notifications, Apple Health, or iCloud availability. If You deny or revoke permissions, some features may not work.

Voice input is for convenience only. Transcriptions may be wrong, incomplete, or unavailable. You are responsible for reviewing dictated workout notes before saving or relying on them.

Apple Health sync is optional. If enabled, Workout may write saved workouts to Apple Health and may request read access to confirm Health authorization. Apple Health data is controlled through Your Device, Apple account, and Apple Health settings.

Notifications are reminders only. They are not emergency alerts and should not be relied on for health, safety, or time-critical purposes.

## Subscriptions and In-app Purchases

The Application may include In-app Purchases, including Subscriptions for premium features such as Pro logging, progress, insights, history, or other paid features.
...
You may choose to create, import, dictate, edit, save, export, or delete workout notes, training history, custom exercises, parser corrections, settings, and progress information in the Service. You are responsible for information You enter into the Application.
...
You are responsible for maintaining backups of any information You want to keep. We are not responsible for data loss caused by device failure, deletion, operating system behavior, account changes, unavailable iCloud services, import or export mistakes, or other events outside Our reasonable control.

## Acceptable Use

You agree not to misuse the Service or attempt to interfere with it. You may not:

- Use the Service for unlawful, harmful, deceptive, or unsafe purposes.
- Use the Service as a substitute for medical, safety, or professional exercise advice.
...
- Upload, enter, import, export, or send unlawful, harmful, abusive, misleading, or infringing content into any note, file, or support channel.
...
The Service may rely on or link to third-party services, including Apple services such as the Application Store, in-app purchases, notifications, speech recognition, Apple Health, iCloud, operating system diagnostics, and device permissions. The Service may also use providers such as RevenueCat for subscriptions and PostHog for analytics if configured.
...
For Applications downloaded through the Apple App Store, Apple's standard licensed application terms may also apply. Apple and Apple's subsidiaries are third-party beneficiaries of these Terms to the extent required by Apple's App Store terms.

## Termination

We may suspend or terminate access to the Service if You breach these Terms or if We discontinue the Service.

You may stop using the Service at any time. Deleting the Application may remove local data from Your Device, but data stored in backups, iCloud, Apple Health, Application Store purchase records, Service Provider systems, or support communications may remain according to the policies of those services and Our Privacy Policy.

## Limitation of Liability

To the maximum extent permitted by applicable law, the Company and its suppliers will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages, including lost profits, data loss, business interruption, personal injury, health-related decisions, workout injuries, or loss of privacy arising from or related to use of, or inability to use, the Service.
...
We do not warrant that the Service will meet Your requirements, improve fitness, prevent injury, operate without interruption, work with every Device, parse every workout note correctly, preserve every record, provide accurate insights, or be free from errors or defects.
...
If You have questions about these Terms, You can contact Us by email at hello@spammusubi.com.
