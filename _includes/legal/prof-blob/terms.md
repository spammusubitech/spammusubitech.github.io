...
Please read these Terms and Conditions carefully before using Prof Blob.
...
Your use of the Service is also subject to Our Privacy Policy, which explains how the Application handles information related to Screen Time permissions, protected apps, math gates, progress, analytics, purchases, device permissions, and support requests.
...
The Service may provide protected-app selection, app shields, math challenges, unlock passes, cooldowns, Hard Hours, rules, streaks, progress summaries, analytics, reminders, local notifications, and Subscription-based premium features.
...
## Screen Time Permissions, Shields, and Notifications
...
Apple controls the Screen Time APIs, DeviceActivity reports, ManagedSettings shields, operating system behavior, notification delivery, and related permissions. The Service may be unavailable, delayed, inaccurate, incomplete, or affected by Device settings, operating system updates, app extensions, network conditions, iCloud settings, Focus modes, Screen Time restrictions, battery state, or other factors outside Our control.
...
## Math Gates and Unlock Passes

Prof Blob may ask You to solve a math challenge before an app is temporarily unlocked. Challenge level, problem type, cooldown behavior, unlock-pass duration, and rules may vary based on settings, Subscription state, app activity, time of day, failed attempts, or feature flags.

Math problems, answer evaluation, unlock timers, shields, and progress calculations may contain errors or behave unexpectedly. You are responsible for deciding whether to open or avoid an app. We do not guarantee that the Service will reduce screen time, prevent impulsive behavior, block every app open, or improve focus, sleep, productivity, or wellbeing.
...
You may choose protected apps, create rules, configure Hard Hours, solve or abandon gates, walk away from apps, set preferences, and create progress history in the Service. You are responsible for information You enter into the Application and choices You make using the Service.
...
You are responsible for maintaining backups of any information You want to keep. We are not responsible for data loss caused by device failure, deletion, operating system behavior, account changes, iCloud behavior, Screen Time behavior, or other events outside Our reasonable control.
...
- Circumvent purchase, entitlement, security, Screen Time, shield, analytics, or access controls.
- Interfere with the Service, the Application Store, Apple's Screen Time services, RevenueCat, PostHog, or other Service Providers.
...
The Service may rely on or link to third-party services, including Apple services, Screen Time APIs, Application Store services, in-app purchases, notifications, iCloud, operating system diagnostics, RevenueCat, PostHog, analytics, feature flags, legal-page hosting, email, and support providers.
...
You may stop using the Service at any time. Deleting the Application may remove local data from Your Device, but data stored in backups, iCloud, Application Store purchase records, analytics systems, Service Provider records, or support communications may remain according to the policies of those services and Our Privacy Policy.

## Limitation of Liability

To the maximum extent permitted by applicable law, the Company and its suppliers will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages, including lost profits, data loss, business interruption, personal injury, lost productivity, failure to restrict app access, app overuse, or loss of privacy arising from or related to use of, or inability to use, the Service.
